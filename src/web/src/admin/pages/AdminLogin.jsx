...
export default function AdminLogin({ message = "" }) {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      // allow the guard to decide; here we just route back to target
      ...
      <div className="admin-auth-left">
        <div className="admin-auth-inner">
          ...
          <form onSubmit={onSubmit} className="admin-auth-form">
            ...
            <input
              type="email" className="admin-input" value={email}
            ...
            <div className="admin-password-row">
              <input
                type="password" className="admin-input" value={password}
